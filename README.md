...
###### Community Support
[**Discord**](https://discord.gg/UbQyNNs) and [**Gitter.im**](https://gitter.im/bchavez/RethinkDb.Driver) are the primary means of getting help for free. **Discord** is recommended since voice chat can be helpful when debugging support issues. If your **C#** related question can't be answered by anyone tag **@bchavez** in your question.
