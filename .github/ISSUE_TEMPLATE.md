...
- [ ] **AVOID** using the issue tracker for questions or help. Submitting issues to this repository are usually reserved for bugs, feature requests, or changes to the source code. We have great community help channels to ask for help: Discord (https://discord.gg/UbQyNNs) and Gitter.im (https://gitter.im/bchavez/RethinkDb.Driver). If nobody can answer your C# related question, tag @bchavez in your question. 
